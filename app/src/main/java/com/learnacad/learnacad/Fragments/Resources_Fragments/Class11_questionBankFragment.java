...
public class Class11_questionBankFragment extends Fragment {
    ...
    ArrayList<Material> class11QB_MaterialsFormula;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        class11QB_MaterialsFormula = new ArrayList<>();

        adapter = new Resouces_RecyclerView_Adapter(getActivity(),class11QB_MaterialsFormula);
    ...
    private void fetchData() {
        ...
        if(isConnected()) {
            ...
            class11QB_MaterialsFormula.clear();
            final Class11_QuestionBank class11_questionBank = new Class11_QuestionBank();
            ...
            AndroidNetworking.get(Api_Urls.BASE_URL + "authorize/resources")
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            try {
                                ...
                                if(success.contentEquals("true")) {
                                    ...
                                    for (int i = 0; i < class11Materials.length(); ++i) {
                                        ...
                                        sb.append(mName + ",");
                                        class11QB_MaterialsFormula.add(material);
                                    }


                                    class11_questionBank.setStoredInDB(sb.toString());
                                    SugarRecord.save(class11_questionBank);
                        ...
                        public void onError(ANError anError) {
                            new SweetAlertDialog(getActivity(),SweetAlertDialog.ERROR_TYPE)
                                    .setContentText("Connection Error!.\nPlease try again later.(202QBF_RC11)")
                                    .setTitleText("Oops..!!")
                                    .show();
                            progressBar.setVisibility(View.GONE);
                        }
            ...
            List<Class11_QuestionBank> listStored = listAll(Class11_QuestionBank.class);

            if(listStored != null && listStored.size() > 0) {

                Class11_QuestionBank object = listStored.get(0);
                class11QB_MaterialsFormula.clear();
    ...
    public void onDestroyView() {
        ...
        unbinder.unbind();
        SugarRecord.deleteAll(Class11_QuestionBank.class);
    }
