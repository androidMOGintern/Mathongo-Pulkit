...
import com.learnacad.learnacad.Models.OtherExam_PreviousYear;
...
public class OtherExams_PreviousYearFragment extends Fragment {
    ...
    ArrayList<Material> otherExams_MaterialsPreviousFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        otherExams_MaterialsPreviousFragment = new ArrayList<>();

        adapter = new Resouces_RecyclerView_Adapter(getActivity(),otherExams_MaterialsPreviousFragment);
    ...
    private void fetchData() {
        ...
        if(isConnected()) {
            ...
            final OtherExam_PreviousYear otherExam_previousYear = new OtherExam_PreviousYear();
            final StringBuilder sb = new StringBuilder();


            otherExams_MaterialsPreviousFragment.clear();
            ...
            AndroidNetworking.get(Api_Urls.BASE_URL + "authorize/resources")
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if(success.contentEquals("true")) {
                                    ...
                                    JSONArray class11Materials = formula.getJSONArray("Other_Exams");
                                    ...
                                    for (int i = 0; i < class11Materials.length(); ++i) {
                                        ...
                                        material.setCategory_Level_II("Other Exams");
                                        sb.append(mName + ",");
                                        otherExams_MaterialsPreviousFragment.add(material);
                                    }

                                    otherExam_previousYear.setStoredInDB(sb.toString());
                                    SugarRecord.save(otherExam_previousYear);
                        ...
                        public void onError(ANError anError) {
                            ...
                            new SweetAlertDialog(getActivity(),SweetAlertDialog.ERROR_TYPE)
                                    .setContentText("Connection Error!.\nPlease try again later.(202PYF_ROE)")
                                    .setTitleText("Oops..!!")
                                    .show();
                            progressBar.setVisibility(View.GONE);
            ...
            List<OtherExam_PreviousYear> listStored = listAll(OtherExam_PreviousYear.class);

            if(listStored != null && listStored.size() > 0) {

                OtherExam_PreviousYear object = listStored.get(0);
                otherExams_MaterialsPreviousFragment.clear();
    ...
    public void onDestroyView() {
        ...
        unbinder.unbind();
        SugarRecord.deleteAll(OtherExam_PreviousYear.class);
    }
}
