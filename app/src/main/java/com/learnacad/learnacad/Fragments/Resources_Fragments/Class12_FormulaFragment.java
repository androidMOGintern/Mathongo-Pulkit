...
import com.learnacad.learnacad.Models.Class12_Formula;
...
public class Class12_FormulaFragment extends Fragment {
    ...
    ArrayList<Material> class12_MaterialsFormula;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        class12_MaterialsFormula = new ArrayList<>();

        adapter = new Resouces_RecyclerView_Adapter(getActivity(),class12_MaterialsFormula);
    ...
    private void fetchData() {
        ...
        if(isConnected()) {
            ...
            class12_MaterialsFormula.clear();

            final Class12_Formula class12_formula = new Class12_Formula();
            ...
            AndroidNetworking.get(Api_Urls.BASE_URL + "authorize/resources")
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            try {
                                ...
                                if(success.contentEquals("true")) {
                                    ...
                                    for (int i = 0; i < class11Materials.length(); ++i) {
                                        ...
                                        sb.append(mName + ",");
                                        class12_MaterialsFormula.add(material);
                                    }

                                    class12_formula.setStoredInDB(sb.toString());
                                    SugarRecord.save(class12_formula);
                        ...
                        public void onError(ANError anError) {
                            ...
                            new SweetAlertDialog(getActivity(),SweetAlertDialog.ERROR_TYPE)
                                    .setContentText("Connection Error!.\nPlease try again later.(202FF_RC12)")
                                    .setTitleText("Oops..!!")
                                    .show();
                            progressBar.setVisibility(View.GONE);
                        }
            ...
            List<Class12_Formula> class12_formulas = listAll(Class12_Formula.class);

            if(class12_formulas != null && class12_formulas.size() > 0) {

                Class12_Formula class12_formula = class12_formulas.get(0);
                class12_MaterialsFormula.clear();

                String mName = class12_formula.getStoredInDB();
    ...
    public void onDestroyView() {
        ...
        unbinder.unbind();
        SugarRecord.deleteAll(Class12_Formula.class);
    }
}
