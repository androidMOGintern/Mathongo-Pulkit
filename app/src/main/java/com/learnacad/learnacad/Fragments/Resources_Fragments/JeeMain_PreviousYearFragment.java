...
import com.learnacad.learnacad.Models.JeeMains_PreviousYear;
...
public class JeeMain_PreviousYearFragment extends Fragment {
    ...
    ArrayList<Material> jeeMains_MaterialsPreviousFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        jeeMains_MaterialsPreviousFragment = new ArrayList<>();

        adapter = new Resouces_RecyclerView_Adapter(getActivity(),jeeMains_MaterialsPreviousFragment);
    ...
    private void fetchData() {
        ...
        if(isConnected()) {
           ...
           progressBar.setVisibility(View.VISIBLE);
            jeeMains_MaterialsPreviousFragment.clear();
            final JeeMains_PreviousYear jeeMains_previousYear = new JeeMains_PreviousYear();
            ...
            AndroidNetworking.get(Api_Urls.BASE_URL + "authorize/resources")
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if(success.contentEquals("true")) {
                                    ...
                                    JSONArray class11Materials = formula.getJSONArray("JEE_MAINS");
                                    ...
                                    for (int i = 0; i < class11Materials.length(); ++i) {
                                        ...
                                        material.setCategory_Level_II("JEE MAINS");

                                        sb.append(mName + ",");


                                        jeeMains_MaterialsPreviousFragment.add(material);
                                    }

                                    jeeMains_previousYear.setStoredInDB(sb.toString());
                                    SugarRecord.save(jeeMains_previousYear);
                        ...
                        public void onError(ANError anError) {
                            new SweetAlertDialog(getActivity(),SweetAlertDialog.ERROR_TYPE)
                                    .setContentText("Connection Error!.\nPlease try again later.(202PYF_RJM)")
                                    .setTitleText("Oops..!!")
                                    .show();
                            progressBar.setVisibility(View.GONE);
                        }
            ...
            List<JeeMains_PreviousYear> listStored = listAll(JeeMains_PreviousYear.class);

            if(listStored != null && listStored.size() > 0) {

                JeeMains_PreviousYear object = listStored.get(0);
                jeeMains_MaterialsPreviousFragment.clear();
    ...
    public void onDestroyView() {
        ...
        unbinder.unbind();
        SugarRecord.deleteAll(JeeMains_PreviousYear.class);
    }
