...
public class SignUp_Step2a_Fragment extends Fragment {

    View view;
    Unbinder unbinder;

    @BindView(R.id.signUp_step2a_editText1)
    EditText editText1;

    @BindView(R.id.signUp_step2a_editText2)
    EditText editText2;

    @BindView(R.id.signUp_step2a_editText3)
    EditText editText3;

    @BindView(R.id.signUp_step2a_editText4)
    EditText editText4;

    @BindView(R.id.signUp_step2a_chronometerTextView)
    TextView timerTextView;

    @BindView(R.id.signUp_step2a_submitButton)
    Button submitButton;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.sign_up_step2a_layout,container,false);
...
//                                fragmentTransaction.addToBackStack(null).commit();
                    ...
                    public void onError(ANError anError) {
                        ...
                        new SweetAlertDialog(getActivity(),SweetAlertDialog.ERROR_TYPE)
                                .setContentText("Connection Error!\nPlease try again later.(202SPS2A_OTR)")
                                .setTitleText("Oops..!!")
                                .show();
                        progressBar.setVisibility(View.GONE);
                    }
    ...
    private void replaceFragment(){
        ...
        fragmentTransaction.replace(R.id.content_login_frame,new SignUp_Step2_Fragment());
